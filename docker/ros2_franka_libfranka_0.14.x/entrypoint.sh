...
if [ -f "/app/ros2_ws/src/role-ros2/docker/ros2_franka_libfranka_0.14.x/polymetis_ros2.env" ]; then
    # Suppress output when not in interactive terminal (e.g., from entrypoint)
    source /app/ros2_ws/src/role-ros2/docker/ros2_franka_libfranka_0.14.x/polymetis_ros2.env >/dev/null 2>&1 || \
    source /app/ros2_ws/src/role-ros2/docker/ros2_franka_libfranka_0.14.x/polymetis_ros2.env
fi
